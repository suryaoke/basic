                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            <div class="services__thumb">
                                <a href="{{ asset('frontend/') }}services-details.html"><img
                            ...
                            <div class="services__content">
                                ...
                                <h3 class="title"><a href="{{ asset('frontend/') }}services-details.html">Business
                                        Strategy</a></h3>
                                ...
                                <a href="{{ asset('frontend/') }}services-details.html" class="btn border-btn">Read
                                    more</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                ...
                                <h3 class="title"><a href="{{ asset('frontend/') }}services-details.html">Brand
                                        Strategy</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a
                                    forward-looking plan.</p>
                                <ul class="services__list">
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                ...
                                <h3 class="title"><a href="{{ asset('frontend/') }}services-details.html">Product
                                        Design</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a
                                    forward-looking plan.</p>
                                <ul class="services__list">
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                ...
                                <h3 class="title"><a href="{{ asset('frontend/') }}services-details.html">Visual
                                        Design</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a
                                    forward-looking plan.</p>
                                <ul class="services__list">
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            ...
                            <div class="services__content">
                                ...
                                <h3 class="title"><a href="{{ asset('frontend/') }}services-details.html">Web
                                        Development</a></h3>
                                <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a
                                    forward-looking plan.</p>
                                <ul class="services__list">
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            ...
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Banking
                                                    Management System</a></h4>
                                            <a href="{{ asset('frontend/') }}portfolio-details.html"
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Nature of
                                                    Business Strategy System</a></h4>
                                            <a href="{{ asset('frontend/') }}portfolio-details.html"
                                                class="link">Case Study</a>
                                        </div>
                                    </div>
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Product
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Brand
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Development</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Visual
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>UX/UI Design</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Animation
                                                    Management System</a></h4>
                                            <a href="{{ asset('frontend/') }}portfolio-details.html"
                                                class="link">Case Study</a>
                                        </div>
                                ...
                                <div class="portfolio__active">
                                    <div class="portfolio__item">
                                        ...
                                        <div class="portfolio__overlay__content">
                                            <span>Web Design</span>
                                            <h4 class="title"><a
                                                    href="{{ asset('frontend/') }}portfolio-details.html">Graphic
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="partner__content">
                            ...
                            <a href="{{ asset('frontend/') }}contact.html" class="btn">Start a conversation</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="blog">
            <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                <a href="{{ asset('frontend/') }}blog-details.html"><img
                                        src="{{ asset('frontend/') }}assets/img/blog/blog_post_thumb01.jpg" alt=""></a>
                                <div class="blog__post__tags">
                                    <a href="{{ asset('frontend/') }}blog.html">Story</a>
                                </div>
                            </div>
                            <div class="blog__post__content">
                                <span class="date">13 january 2021</span>
                                <h3 class="title"><a href="{{ asset('frontend/') }}blog-details.html">Facebook
                                        design is dedicated to what's new in design</a></h3>
                                <a href="{{ asset('frontend/') }}blog-details.html" class="read__more">Read
                                    mORe</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                ...
                                <div class="blog__post__tags">
                                    <a href="{{ asset('frontend/') }}blog.html">Social</a>
                                </div>
                            </div>
                            <div class="blog__post__content">
                                <span class="date">13 january 2021</span>
                                <h3 class="title"><a href="{{ asset('frontend/') }}blog-details.html">Make
                                        communication Fast and Effectively.</a></h3>
                                <a href="{{ asset('frontend/') }}blog-details.html" class="read__more">Read
                                    mORe</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog__post__item">
                            <div class="blog__post__thumb">
                                ...
                                <div class="blog__post__tags">
                                    <a href="{{ asset('frontend/') }}blog.html">Work</a>
                                </div>
                            </div>
                            <div class="blog__post__content">
                                <span class="date">13 january 2021</span>
                                <h3 class="title"><a href="{{ asset('frontend/') }}blog-details.html">How to
                                        increase your productivity at work - 2021</a></h3>
                                <a href="{{ asset('frontend/') }}blog-details.html" class="read__more">Read
                                    mORe</a>
                            </div>
                        </div>
                ...
                <div class="blog__button text-center">
                    <a href="{{ asset('frontend/') }}blog.html" class="btn">more blog</a>
                </div>
            </div>
        </section>
        <!-- blog-area-end -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="homeContact__content">
                                ...
                                <h2 class="mail"><a
                                        href="{{ asset('frontend/') }}mailto:Info@webmail.com">Info@webmail.com</a>
                                </h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
