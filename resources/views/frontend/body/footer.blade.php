                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget__address">
                            ...
                            <a href="{{ asset('frontend/') }}mailto:noreply@envato.com"
                                class="mail">noreply@envato.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget__social">
                            ...
                            <ul class="footer__social__list">
                                ...
                                <li><a href="{{ asset('frontend/') }}#"><i class="fab fa-behance"></i></a></li>
                                <li><a href="{{ asset('frontend/') }}#"><i class="fab fa-linkedin-in"></i></a>
                                </li>
